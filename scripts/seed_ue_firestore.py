...
BASE_URL = f"https://firestore.googleapis.com/v1/projects/{PROJECT}/databases/(default)/documents/ue_reference_data"

with open("scripts/ue_firestore_data.json") as f:
    data = json.load(f)
...
print("UE reference data written to Firestore: ue_reference_data collection")
